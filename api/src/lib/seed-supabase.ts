...
// Creates Supabase auth accounts for every seed doctor so they can log into the
// doctor portal (admin/). Password: physio123. Idempotent — skips emails that
// already exist in Supabase auth.
