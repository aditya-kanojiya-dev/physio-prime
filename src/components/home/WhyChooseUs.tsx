          ...
          {benefits.map((item) => {
            ...
            return (
              <motion.div
                key={item.title}
                variants={fadeUp(24)}
                className="group relative p-8 rounded-3xl bg-white hover:bg-blue-50 border border-slate-200/90 hover:border-blue-300 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-blue-100/50 flex flex-col justify-between"
              >
