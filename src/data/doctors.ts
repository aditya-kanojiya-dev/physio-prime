...
export const DOCTORS_DATA: Doctor[] = [
  {
    ...
    reviewsList: [
      {
        id: 'rev-1',
        patientName: 'Devshree Kulkarni',
        rating: 5,
        date: '24 June 2026',
        comment: 'Very professional home visit. Dr. Tarannum helped me regain my leg strength post knee replacement in Nagpur within 4 weeks!',
        verified: true,
        treatmentName: 'Knee Replacement Rehab'
      },
      {
        id: 'rev-2',
        ...
        rating: 5,
        date: '12 May 2026',
        comment: 'Punctual home visits in Raj Nagar. My chronic lower back pain has reduced by 90%. Excellent Indian healthcare service.',
        verified: true,
        treatmentName: 'Lumbar Spine Rehab'
      }
    ],
    phone: ''
  },
  {
    id: 'doc-pritam-rathod',
    ...
    reviewsList: [
      {
        ...
        rating: 5,
        date: '10 July 2026',
        comment: 'Dr. Pritam is outstanding! He cured my acute hamstring strain before the marathon. Best doctor in Nagpur.',
        verified: true,
        treatmentName: 'Sports Injury Therapy'
      }
    ],
    phone: ''
  },
  {
    id: 'doc-jayshree-ingole',
    ...
    reviewsList: [
      {
        ...
        rating: 5,
        date: '02 June 2026',
        comment: 'Extremely supportive and knowledgeable during my postpartum recovery at home.',
        verified: true,
        treatmentName: 'Postnatal Care'
      }
    ],
    phone: ''
  },
  {
    id: 'doc-pratyush-kulkarni',
